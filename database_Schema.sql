...
-- First, make sure your CSV paths are correct
COPY departments FROM 'C:\Users\Kehleboe\OneDrive\Documents\upenndata\module9 challenge\Starter_Code\data\departments.csv' DELIMITER ',' CSV HEADER;
COPY titles FROM 'C:\Users\Kehleboe\OneDrive\Documents\upenndata\module9 challenge\Starter_Code\data\titles.csv' DELIMITER ',' CSV HEADER;
COPY employees FROM 'C:\Users\Kehleboe\OneDrive\Documents\upenndata\module9 challenge\Starter_Code\data\employees.csv' DELIMITER ',' CSV HEADER;
COPY dept_emp FROM 'C:\Users\Kehleboe\OneDrive\Documents\upenndata\module9 challenge\Starter_Code\data\dept_emp.csv' DELIMITER ',' CSV HEADER;
COPY dept_manager FROM 'C:\Users\Kehleboe\OneDrive\Documents\upenndata\module9 challenge\Starter_Code\data\dept_manager.csv' DELIMITER ',' CSV HEADER;
COPY salaries FROM 'C:\Users\Kehleboe\OneDrive\Documents\upenndata\module9 challenge\Starter_Code\data\salaries.csv' DELIMITER ',' CSV HEADER;